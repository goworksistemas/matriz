  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <p className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Performance e Tendencia</p>
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base"><Clock3 className="h-4 w-4 text-cyan-500" /> Lead Time Medio</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <div className="space-y-3">
        <p className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Distribuicao</p>
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
      ...
      <div className="space-y-3">
        <p className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Alocacao e Gargalos</p>
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <Card className="xl:col-span-2">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
          ...
          <Card className="xl:col-span-2">
            ...
            <CardContent>
              <BarChartComponent
                ...
                height={Math.max(320, Math.min(640, dadosGraficoExecutores.length * 42))}
                layout="vertical"
          ...
          <Card className="border-red-200/60 dark:border-red-500/20 bg-red-50/30 dark:bg-red-500/5">
            ...
            <CardContent>
              {gargalosCriticos.length === 0 ? (
                <div className="h-[340px] flex items-center justify-center text-sm text-emerald-600 dark:text-emerald-400">
      ...
      <div className="space-y-3">
        <p className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Priorizacao</p>
        <Card>
        <CardHeader>
